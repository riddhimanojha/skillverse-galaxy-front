...
export const NebulaMaterial = shaderMaterial(
  {
    time: 0,
    colorA: new THREE.Color(0.25, 0.1, 0.4), // Deep purple
    colorB: new THREE.Color(0.5, 0.2, 0.7), // Cosmic violet
    colorC: new THREE.Color(0.15, 0.05, 0.25), // Dark space
  },
  // Vertex Shader
  `
    varying vec2 vUv;
  ...
  `,
  // Fragment Shader - Smooth, slow-moving nebula
  `
    uniform float time;
    uniform vec3 colorA;
    uniform vec3 colorB;
